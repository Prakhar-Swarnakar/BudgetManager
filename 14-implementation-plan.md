...
**Status on 24 September 2026:** design is complete. Phase 1 (the SMS, notification, and install test) is written and waiting for you to run it. No real app code exists yet.
